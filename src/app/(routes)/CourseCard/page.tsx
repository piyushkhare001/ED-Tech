  ...
  return (
    <Tilt>
        <div className='bg-white rounded-lg overflow-hidden cursor-pointer w-[350px]'> 
            ...
            <div className='p-4'>
                <h1 className='ml-auto relative z-[10] h-20 w-20 flex items-center text-xl font-bold justify-center flex-col mt-[-4rem] rounded-full bg-[#9e032a] text-white'>${course.price}</h1>
                <div className='lex items-center mt-5 space-x-4'>
                    <span className='text-lg text-black text-opacity-70 font-bold ml-2'>{course.author}</span>
                </div>
